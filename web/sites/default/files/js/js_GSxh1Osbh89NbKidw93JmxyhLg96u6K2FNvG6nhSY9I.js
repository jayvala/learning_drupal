...
(function ($, Drupal) {
  Drupal.behaviors.locationDisplay = {
    attach: function(context, drupalSettings) {
      //var clock = drupalSettings.time;
      window.setInterval(function ()
      {
        //var currentTime = drupalSettings.time;
        var timeZone = drupalSettings.timezone;
        var currentTime = new Date ();
        var utcDate = currentTime.toUTCString();
        var tzDate = new Date(currentTime.toLocaleString('en-US', { timeZone: timeZone }));
        //currentTime.toLocaleString('en-US', {timezone: 'Europe/London' });
        //currentTime = dateWithTimeZone(timeZone);

        var currentDay = tzDate.getDay ( );
        var currentDate = tzDate.getDate ( );
        var currentMon = tzDate.getMonth ( ) + 1;
        ...
        // currentMon = currentTime.getMonth ( ) + 1;
        // currentYr = currentTime.getFullYear ( );
        ...
        var currentDateString = currentDate + " " + currentMon + " " + currentYr
        
        $('div.clock').html("DateTime" + '<strong>' + currentDateString + " " + currentTimeString + '</strong>');
...
// function dateWithTimeZone(timeZone) {
//   let date = new Date();
