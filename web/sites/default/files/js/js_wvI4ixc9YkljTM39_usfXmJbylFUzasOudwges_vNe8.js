  ...
  Drupal.behaviors.locationDisplay = {
    attach: function(context, drupalSettings) {
      ...
      window.setInterval(function ()
      {
        ...
        currentTime = dateWithTimeZone(timeZone, currentYr, currentMon, currentDay, currentHours, currentMinutes, currentSeconds);
        alert(currentTime);
        ...
        $('div.clock').html(currentDateString + " " + currentTimeString);
